...
class ZnZzTest(MyTestCase):
    ...
    def test_znzz_1(self):
        ...
        time.sleep(2)
        # self.driver.find_element_by_css_selector("#qiye-postcode").clear()
        # self.driver.find_element_by_css_selector("#qiye-postcode").send_keys("102200")
        # self.driver.find_element_by_css_selector("#qiye-street").clear()
        # self.driver.find_element_by_css_selector("#qiye-street").send_keys("北京市昌平区")
        self.driver.find_element_by_css_selector(
